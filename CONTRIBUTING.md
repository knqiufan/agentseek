...
Report bugs at https://github.com/ob-labs/agentseek/issues
...
The best way to send feedback is to file an issue at https://github.com/ob-labs/agentseek/issues.
...
1. Fork the `agentseek` repo on GitHub.

2. Clone your fork locally:

```bash
cd <directory_in_which_repo_should_be_created>
git clone git@github.com:YOUR_NAME/agentseek.git
```
